...
def setupDataframe():
	...
	choice = input(
		"Would you prefer to use all years of data, or a specific year? (all, specific) "
	)
	if choice == "all":
		year = allYears
	elif choice == "specific":
		specificYear = int(
			input("What year would you like to use? use format: '1999' "))
		year[0] = specificYear
	else:
		print("That's not a valid choice. Try again.")
		setupDataframe()
...
def findGameID():
	...
	week = input(
		"What week was the game? Add a leading zero if it's a single digit. ")
